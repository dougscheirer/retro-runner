...
phil=User.create(:name=>"Phil",:email=>"phil@perforce.com",:password=>"notsecure",:password_confirmation=>"notsecure")
joe=User.create(:name=>"Joe",:email=>"joe@perforce.com",:password=>"notsecure",:password_confirmation=>"notsecure")
